    ...
    public function collection(Collection $records){
        ...
        foreach($records as $k=>$record){
            ...
            if(!isset($record['total_product_quantity'])){
                ...
                $dataToInsertOrUpdate[$k]['product_quantity']=trim(($record['total_product_quantity']));
        ...
        if(empty($sheetError)){
            ...
            $vendorProduct=VendorProduct::upsert($dataToInsertOrUpdate,['product_title'],['product_quantity','discription','product_warrenty','brand_id','product_category_id']);
