            ...
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="font-weight-bold mb-0">MjCreation Dashboard</h4>
                        </div>
                        <div>
        ...
        <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="#"
                        target="_blank">mahajyoticreation.com </a>2024</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Design & Developed By <a
                        href="https://www.bootstrapdash.com/" target="_blank"> Appzglobaltech.com </a></span>
            </div>
        </footer>
        <!-- partial -->
    </div>
